...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SIPASUT'); ?> - Sistem Informasi Pasang Surut Air Laut Jawa Timur</title>
    ...
    <header class="sticky top-0 z-40 bg-white/95 backdrop-blur-md border-b border-slate-200/80 shadow-xs">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16 sm:h-20">
                <!-- Logo & Brand -->
                <a href="<?php echo e(route('user.dashboard')); ?>" class="flex items-center gap-3 group">
                ...
                <nav class="hidden md:flex items-center gap-1 text-sm font-semibold">
                    <a href="<?php echo e(route('user.dashboard')); ?>" 
                       class="px-3.5 py-2 rounded-lg transition-colors <?php echo e(request()->routeIs('user.dashboard') ? 'bg-sky-50 text-sky-700 font-bold' : 'text-slate-600 hover:text-sky-600 hover:bg-slate-50'); ?>">
                        Dashboard
                    </a>
                    <a href="<?php echo e(route('user.kondisi')); ?>" 
                       class="px-3.5 py-2 rounded-lg transition-colors <?php echo e(request()->routeIs('user.kondisi') ? 'bg-sky-50 text-sky-700 font-bold' : 'text-slate-600 hover:text-sky-600 hover:bg-slate-50'); ?>">
                        Kondisi Pasang Surut
                    </a>
                    <a href="<?php echo e(route('user.monitoring')); ?>" 
                       class="px-3.5 py-2 rounded-lg transition-colors <?php echo e(request()->routeIs('user.monitoring') ? 'bg-sky-50 text-sky-700 font-bold' : 'text-slate-600 hover:text-sky-600 hover:bg-slate-50'); ?>">
                        Lokasi Monitoring
                    </a>
                    <a href="<?php echo e(route('user.calendar')); ?>" 
                       class="px-3.5 py-2 rounded-lg transition-colors <?php echo e(request()->routeIs('user.calendar') ? 'bg-sky-50 text-sky-700 font-bold' : 'text-slate-600 hover:text-sky-600 hover:bg-slate-50'); ?>">
                        Kalender
                    </a>
                </nav>
                ...
                <div class="flex items-center gap-3">
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(Auth::user()->isAdmin()): ?>
                            <a href="<?php echo e(route('admin.data')); ?>" class="inline-flex items-center gap-2 px-3.5 py-2 rounded-lg text-xs font-semibold bg-sky-600 text-white hover:bg-sky-700 shadow-sm transition">
                    ...
                    <?php else: ?>
                        <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl text-xs font-bold text-slate-700 bg-slate-100 hover:bg-slate-200 hover:text-slate-900 transition">
        ...
        <div class="md:hidden border-t border-slate-200 bg-white grid grid-cols-4 text-center py-2 text-[11px] font-medium">
            <a href="<?php echo e(route('user.dashboard')); ?>" class="<?php echo e(request()->routeIs('user.dashboard') ? 'text-sky-600 font-bold' : 'text-slate-500'); ?>">Dashboard</a>
            <a href="<?php echo e(route('user.kondisi')); ?>" class="<?php echo e(request()->routeIs('user.kondisi') ? 'text-sky-600 font-bold' : 'text-slate-500'); ?>">Kondisi</a>
            <a href="<?php echo e(route('user.monitoring')); ?>" class="<?php echo e(request()->routeIs('user.monitoring') ? 'text-sky-600 font-bold' : 'text-slate-500'); ?>">Lokasi</a>
            <a href="<?php echo e(route('user.calendar')); ?>" class="<?php echo e(request()->routeIs('user.calendar') ? 'text-sky-600 font-bold' : 'text-slate-500'); ?>">Kalender</a>
        </div>
    </header>
...
<?php /**PATH C:\Users\minah\SipasutBMKG-app\resources\views/layouts/app.blade.php ENDPATH**/ ?>